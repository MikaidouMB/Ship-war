...
$databaseUser = 'mikaidou';
$databasePassword = 'admin';

/*
 * CREATE THE DATABASE
 */
$pdoDatabase = new PDO('mysql:host=localhost;dbname='.$databaseName,'mikaidou','admin', $databasePassword);
 ...
 * CREATE THE TABLE
 */
$pdo = new PDO('mysql:host=localhost;dbname='.$databaseName,'mikaidou','admin', $databasePassword);
